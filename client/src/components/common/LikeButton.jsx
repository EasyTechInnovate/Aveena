...
function LikeButton() {
  ...
  return (
    <button
      ...
      className="absolute top-3 right-3 bg-white p-2 rounded-full shadow transition transform active:scale-95"
    >
      {liked ? (
        // Filled Heart
        <svg
